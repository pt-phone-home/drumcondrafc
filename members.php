...
<head>
    ...
    ?>
    <title>Members - Drumcondra A.F.C</title>
</head>
<body>
        ...
        <div class="members-sections">
            <div class="members-sections-data">
                ...
                <div class="members-sections-data-body">
                    <p>When Drumcondra AFC –the Club- collects annual membership subscriptions, it collects data that helps it maintain its football activities and related health and safety and club development activities. The Club will only ever look for necessary information from members (and parents/guardians knowingly acting on behalf of a child under 18 years of age. Such information will most usually be player name, date of birth, contact number/email and health conditions. <br> <br>
                    For more information click <a href="#!" class="btn-flat data-modal-btn">Here</a>
            ...
            <div class="members-sections-conduct">
                ...
                <div class="members-sections-conduct-body">
                    <p>Drumcondra AFC, the Club, players, coaches, and guardians, strive to implement and encourage an approach to football activity emphasising fair play. This is underpinned by the Club’s belief that enjoyment and growth are the primary rewards from involvement in football at Drumcondra AFC. <br><br>

                    The code of conduct sets out the Club’s expectations of those coming together under its name.

                    <br> <br>
                    For more information click <a href="#!" class="btn-flat conduct-modal-btn">Here</a>
            ...
            <div class="members-sections-forms">
                ...
                <div class="members-sections-forms-body">
                    <p>Below you can access (download) forms for reporting <strong>accidents and incidents</strong> and the registration form for <strong>new managers</strong> <br><br> <br>

                   
                    Form for new managers <a href="files/registration-form-for-new-managers.docx" download class="btn-flat"><i class="fas fa-download"></i></a> <br><br> <br>

                    Accident-Incident form <a href="files/accident-incident-form.docx" download class="btn-flat"><i class="fas fa-download"></i></a>
            ...
            <div class="members-sections-payment">
                ...
                <div class="members-sections-payment-body">
                    <p>Our new electronic payment system is now up and running. We are using the same company used by other clubs in Drumcondra so your login might already exists.</p> <br><p>First click on the button ‘Pay Now’ as it will bring you to a Safe easypaymentsplus.ie website. On the link belw you will find a comprehensive guide on how to register and make the payment.<br><br>

                    <a href="https://pay.easypaymentsplus.com/feepay1v2.aspx?id=931" target="_blank"><img src="img/epp_pay_now_1.gif" alt=""></a>
    ...
    <div class="data-modal" id="data-modal">
        <div class="data-modal-content">
            ...
            <h2>Background</h2>
                ...
                <p>When Drumcondra AFC –the Club- collects annual membership subscriptions it collects data that helps it maintain its football activities and related health and safety and club development activities. The Club will only ever look for necessary information from members (and parents/guardians knowingly acting on behalf of a child under 18 years of age. Such information will most usually be player name, date of birth, contact number/email and health conditions. </p>

<p>Once the Club collects such information it is subject to Data Protection requirements set down in law (1988 and 2003).</p>

<p> Data Protection laws place an onus on the Club to: <br> <br>
...
<p>The Club will provide the relevant Club coach with the given contact name and number of each player in order to facilitate training and matches and, where necessary, other club activities.
...
You have the option to have your details removed from the database and the Club will do so no more than 40 days after you request this. <br><br>

Once a member has been removed from the Club database their contact details cannot be used again by the Club.<br><br> 

The Club will review data at least once a year to ensure that it is correct, this will coincide with renewal of memberships. Consequently, any data not still in use for membership purposes at that point in time will be destroyed. <br><br>

The Club uses an online facility to handle all memberships completed online. This is provided by Easy Payments Plus for the 2017-18 season. <br><br>

All membership subscriptions completed online will result in the recording of credit/debit card details, name and address and other details provided.<br><br>

The Club must ensure that all information provided with a membership payment made online is held by Easy Payments Plus in accordance with Data Protection requirements.</p>
 

<h3>Breaches</h3>

<p>A breach of Data Protection arises when an incident of risk of personal data being disclosed, lost, destroyed or altered occurs. <br><br>
If this happens the Club must consider notifying the affected member(s) and/or parents/guardians.<br><br>
Where the Club is concerned about the nature of a (likely) breach it will also inform the Office of the Data Protection Commissioner no later than two days after becoming aware of the breach.<br><br>
...
Keep a summary record of each incident of loss and any reason for not informing the Office of the Data Protection Commissioner about the matter.</p>
 

<h3>Rights and Obligations of Members and their guardians </h3>

<p>A member can request a copy of all of the information about them held by the Club in what is called a ‘Subject Access Request’. Any such request must be made in writing.
...
A member has the right to correct, modify or remove the personal information the Club holds about them. All such requests must be made in writing and will not incur a fee.</p>
 

<h3>Complaint Procedure</h3>

<p>Where a member wishes to complain about a Data Protection issue the following mechanism has been put in place: <br><br>
...
The Club will provide the member with an initial response within 10 days. </p>
 

<h3>Queries</h3>

<p>All queries about this policy should be directed to the Secretary of Chair of the Club whose details are posted on the Contacts page of the Club website www.drumcondrafc.com.</p>
        </div>
    </div>
...
This code of conduct sets out the Club’s expectations of those coming together under its name. </p>
